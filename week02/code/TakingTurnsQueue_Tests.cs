...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 
    // - Dequeue was returning people in the wrong order. Expected Bob, but got Sue.
    // - Enqueue method was adding people at the front of the queue rather than the back.
    ...
    // Defect(s) Found: 
    // - Dequeue was returning people in the wrong order. Expected Tim, but got Sue.
    // - Enqueue method was adding people at the front of the queue rather than the back.
    ...
    // Defect(s) Found: 
    // - No issues found. This test passed successfully.
